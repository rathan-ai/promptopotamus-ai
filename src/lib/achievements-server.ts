...
/**
 * Server-side Achievement Engine - Manages user achievements, XP, and streaks
 */
export class ServerAchievementEngine {
    ...
    try {
      ...
      switch (type) {
        ...
        case 'followers_count':
          const followerProfile = await supabase
            .from('user_profiles_extended')
...
export const serverAchievementEngine = new ServerAchievementEngine();