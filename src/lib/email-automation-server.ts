...
/**
 * Server-side Email Automation System
 */
export class ServerEmailAutomation {
   ...
   */
  private async logEmailSend(sendData: any): Promise<void> {
    try {
      const supabase = await this.getSupabase();
...
export const serverEmailAutomation = new ServerEmailAutomation();

// Helper functions
export async function sendWeeklyDigestToUser(userId: string): Promise<boolean> {
  return serverEmailAutomation.sendCampaignEmail(userId, 'weekly_digest');
}
...
export async function sendAchievementNotification(
  ...
  return serverEmailAutomation.sendAchievementNotification(
    userId,
    achievementName,
