    ...
    <div class="space-y-6">
      <div class="grid md:grid-cols-2 gap-6">
        <article class="p-6 bg-neutral-100 dark:bg-neutral-800/50 rounded-xl border border-neutral-200 dark:border-neutral-700/50">
          <h4 class="font-semibold text-lg mb-2 text-neutral-900 dark:text-white">Zero-Shot Prompting</h4>
          <p class="text-neutral-600 dark:text-neutral-400 mb-4">The simplest form: just ask the model to perform a task with no prior examples.</p>
        ...
        <article class="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-700/50">
          <h4 class="font-semibold text-lg mb-2 text-blue-900 dark:text-blue-200">One-Shot Prompting</h4>
          <p class="text-blue-700 dark:text-blue-300 mb-4">Provide a single example to demonstrate the desired format and style.</p>
      ...
      <article class="p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-700/50">
        <h4 class="font-semibold text-lg mb-2 text-green-900 dark:text-green-200">Few-Shot Prompting</h4>
        <p class="text-green-700 dark:text-green-300 mb-4">Provide multiple examples (2-5) to teach the model the desired pattern and format.</p>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <article class="p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-700/50">
          <h4 class="font-semibold text-lg mb-2 text-purple-900 dark:text-purple-200">System Prompting</h4>
          <p class="text-purple-700 dark:text-purple-300 mb-4">Set the AI's role and behavior with system-level instructions.</p>
        ...
        <article class="p-6 bg-orange-50 dark:bg-orange-900/20 rounded-xl border border-orange-200 dark:border-orange-700/50">
          <h4 class="font-semibold text-lg mb-2 text-orange-900 dark:text-orange-200">Role Prompting</h4>
          <p class="text-orange-700 dark:text-orange-300 mb-4">Ask the AI to assume a specific role or persona for specialized responses.</p>
      ...
      <article class="p-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-700/50">
        <h4 class="font-semibold text-lg mb-2 text-yellow-900 dark:text-yellow-200">Contextual Prompting</h4>
        <p class="text-yellow-700 dark:text-yellow-300 mb-4">Provide relevant background context to help the AI understand the situation better.</p>
