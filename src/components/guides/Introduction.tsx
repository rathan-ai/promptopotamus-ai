    ...
    <Section id="introduction" title="Welcome to Promptopotamus">
      ...
      <div className="text-center mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="group p-6 bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-neutral-700/50 hover:bg-white/70 dark:hover:bg-neutral-800/70 transition-all duration-300 hover:scale-105">
            <div className="w-12 h-12 bg-gradient-to-br from-slate-500 to-pink-500 rounded-xl flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform">
          ...
          <div className="group p-6 bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-neutral-700/50 hover:bg-white/70 dark:hover:bg-neutral-800/70 transition-all duration-300 hover:scale-105">
            <div className="w-12 h-12 bg-gradient-to-br from-emerald-600 to-emerald-500 rounded-xl flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform">
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 via-slate-600/10 to-pink-600/10 dark:from-blue-400/10 dark:via-purple-400/10 dark:to-pink-400/10 rounded-2xl blur-xl"></div>
        <div className="relative glass rounded-2xl p-8 text-center">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500/10 to-slate-500/10 rounded-full text-small font-medium text-indigo-700 dark:text-indigo-300 mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Link href="/smart-prompts">
              <Button size="lg" className="bg-gradient-to-r from-indigo-600 to-slate-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 group">
