  ...
  if (!settings) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-slate-600 dark:text-red-400">Failed to load settings</p>
    ...
    <div className="space-y-6">
      ...
      {usingFallback && settings && (
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <div className="flex items-center gap-2">
            <AlertTriangle className="w-5 h-5 text-yellow-600 dark:text-slate-400" />
            <div>
              ...
              <div className="text-xs text-yellow-600 dark:text-slate-400 mt-2 space-y-1">
                <p>Possible issues:</p>
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-emerald-700 dark:text-green-300 mt-1">
